<div style="font-family:Arial,Helvetica,sans-serif;">
    ...
    <h1 style="margin:10px 0 16px;font-family:Georgia,'Times New Roman',serif;font-size:32px;line-height:1.15;color:#1c1917;">Szczęść Boże! Potwierdź swój adres e-mail.</h1>
    <p style="margin:0 0 14px;font-size:16px;line-height:1.8;color:#475569;">
        Dziękujemy za dołączenie do newslettera Wspólnoty. To tutaj będziemy dzielić się rozwojem usługi i ważnymi nowościami.
    </p>
    <p style="margin:0 0 20px;font-size:16px;line-height:1.8;color:#475569;">
        Zostało jeszcze tylko jedno potwierdzenie. Jeśli to nie Ty zapisywałeś ten adres, po prostu zignoruj tę wiadomość.
    </p>
    ...
    <div style="padding:16px 18px;border-radius:18px;background-color:#f8f3ec;border:1px solid #eadfce;font-size:14px;line-height:1.8;color:#57534e;">
        Jeśli nie chcesz otrzymywać wiadomości z tej listy, możesz od razu wypisać ten adres:
