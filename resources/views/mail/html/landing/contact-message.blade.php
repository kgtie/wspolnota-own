<div style="font-family:Arial,Helvetica,sans-serif;">
    ...
    <h1 style="margin:10px 0 18px;font-family:Georgia,'Times New Roman',serif;font-size:30px;line-height:1.15;color:#1c1917;">Nowa wiadomość z formularza na stronie głównej.</h1>
    ...
    <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="border:1px solid #eadfce;border-radius:18px;background-color:#fffdf9;">
        <tr>
            <td style="padding:16px 18px;font-size:15px;line-height:1.8;color:#475569;">
                ...
                <strong>Adres e-mail:</strong> {{ $email }}<br>
                @if (filled($parish))
