...
<head>
    ...
    <title>{{ $pageInfo['page.title'] }} | Wspólnota | Panel administratora</title>
...
<body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
    <div class="app-wrapper">
        ...
        <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
                ...
                <a href="{{ route('admin.dashboard') }}" class="brand-link"><span class="brand-text fw-light">Panel administracyjny</span></a>
            </div>
