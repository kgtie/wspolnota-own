<x-filament-panels::page>
    ...
    <div class="office-inbox-layout" wire:poll.8s="refreshThread">
                        ...
                        <div class="office-conversation-item__header">
                            <div class="office-conversation-item__identity">
                                ...
                                <div class="office-conversation-item__identity-text">
                                    ...
                                    <p class="office-conversation-item__email">{{ $parishionerEmail }}</p>
                                </div>
                            </div>
        ...
        <x-filament::section
            ...
            :description="$selectedConversation ? ($threadEmail . ' · ' . $threadParish) : 'Po wybraniu konwersacji zobaczysz tresc rozmowy i formularz odpowiedzi.'"
        >
            @if ($selectedConversation)
                <x-slot name="afterHeader">
                    <div class="office-thread-toolbar">
                        ...
                        @else
                            <div class="office-thread-status">
                                <x-filament::badge color="gray" size="sm">Konwersacja zamknieta</x-filament::badge>
                            </div>
                        @endif
                    </div>
                </x-slot>
                ...
                >
                    @forelse ($selectedConversation->messages as $message)
                        @php
                            $isPriestMessage = (int) $message->sender_user_id === (int) $priestId;
                            $sender = $message->sender;
                            $senderLabel = $sender?->full_name ?: $sender?->name ?: ($isPriestMessage ? 'Proboszcz' : 'Parafianin');
